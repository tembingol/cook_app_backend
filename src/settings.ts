...
export const SETTINGS = {
    ...
    SMSMANAGERHOST: process.env.SMSMANAGERHOST || 'https://sms.ru/sms/send',
    SMSMANAGERLOGIN: process.env.SMSMANAGERLOGIN || 'USER',
    SMSMANAGERPASSWORD: process.env.SMSMANAGERPASSWORD || 'PASSWORD',
    SMSMANAGERAPIKEY: process.env.SMSMANAGERAPIKEY || 'SMSMANAGERAPIKEY',
